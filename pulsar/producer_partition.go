...
import (
	...
	"github.com/toasttab/pulsar-client-go/pulsar/internal/compression"
	internalcrypto "github.com/toasttab/pulsar-client-go/pulsar/internal/crypto"
...
func (p *partitionProducer) failTimeoutMessages() {
	...
	for range t.C {
		...
		// see https://github.com/toasttab/pulsar-client-go/pull/301
